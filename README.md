...
A single-screen iOS app that streams the camera feed, performs OCR on an electronic readout using Apple Vision, and overlays running statistics plus a trend chart of the detected values.
...
- `CameraViewModel.swift`: Capture session management, Vision OCR, and running statistics.
